<template><div><h3 id="语言" tabindex="-1"><a class="header-anchor" href="#语言"><span>语言</span></a></h3>
<ol>
<li>Java</li>
<li>JavaScript</li>
<li>TypeScript</li>
...
<ol>
<li>
<p><a href="https://cn.vuejs.org/" target="_blank" rel="noopener noreferrer">Vue3</a></p>
<blockquote>
...
<li>
<p><a href="https://tauri.app/" target="_blank" rel="noopener noreferrer">Tauri</a></p>
<blockquote>
<p>Tauri 是一个构建适用于所有主流桌面和移动平台的轻快二进制文件的框架。开发者们可以集成任何用于创建用户界面的可以被编译成 HTML、JavaScript 和 CSS 的前端框架，同时可以在必要时使用 Rust、Swift 和 Kotlin 等语言编写后端逻辑。</p>
</blockquote>
</li>
</ol>
...
<p>You can use Spring Boot to create Java applications that can be started by using <code v-pre>java -jar</code> or more traditional war deployments.</p>
</blockquote>
</li>
<li>
...
<p>/</p>
<p>MyBatis 最佳搭档，只做增强不做改变，为简化开发、提高效率而生。</p>
</blockquote>
</li>
</ol>
